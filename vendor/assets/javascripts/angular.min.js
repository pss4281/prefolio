...
(function(Z, Q, r) {
    ...
    function F(b) {
        return function() {
            var a = arguments[0],
                c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.10-build.2164+sha.8b395ff/" + (b ? b + "/" : "") + a;
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a, b, l, n, p, s, C, y, E, u, R, H) {
            ...
            function ia(a, c, d, e, g, f, m, n, p) {
                ...
                for (var T = !1, z = !1, t = d.$$element = A(c), G, da, U, F = e, O, M = 0, na = a.length; M < na; M++) {
                    ...
                    t = d.$$element = A(Q.createComment(" " + da + ": " + d[da] + " ")), c = t[0], ib(g, A(va.call(U, 0)), c), F = v(U, e, N, f && f.name, {
    ...
    var Uc = /[A-Z]/g,
        ...
        }, Ra = O.cache = {}, eb = O.expando = "ng-" + (new Date).getTime(),
        Yc = 1,
    ...
    q({
        ...
        O.prototype[c] = function(c, e, g) {
            for (var f, h = 0; h < this.length; h++) z(f) ? (f = a(this[h], c, e, g), B(f) && (f = A(f))) : zb(f,
            a(this[h], c, e, g));
            return B(f) ? f : this
        };
                ...
                link: function(e, f, h, m) {
                    ...
                    function n(e, f, g) {
                        function h() {
                            ...
                            r = !1;
                            var E, H;
                            if (s) if (w && K(t)) for (r = new Sa([]), z = 0; z < t.length; z++) I[m] = t[z], r.put(w(e, I), t[z]);
                            else r = new Sa(t);
